...
import io.asgardeo.java.oidc.sdk.OIDCManager;
...
public class OIDCRequestBuilder {
    ...
    /**
     * Returns {@link io.asgardeo.java.oidc.sdk.request.model.LogoutRequest} Logout request. To build the logout request,
     ...
     */
    public io.asgardeo.java.oidc.sdk.request.model.LogoutRequest buildLogoutRequest(SessionContext sessionContext)
